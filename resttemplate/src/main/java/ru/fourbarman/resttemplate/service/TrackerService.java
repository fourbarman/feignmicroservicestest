package ru.fourbarman.resttemplate.service;
...
import ru.fourbarman.resttemplate.model.Item;
...
public class TrackerService {
    ...
    public Item findById(int id) {
        return client.getForEntity("%s/getById?id=%d".formatted(url, id), Item.class).getBody();
    }
